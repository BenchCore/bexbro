...
var BexLedgerWallet = function(comm) {
	this.comm = comm;
	this.comm.setScrambleKey('w0w');
}

BexLedgerWallet.prototype.getAddress_async = function(path) {
...
BexLedgerWallet.prototype.signTransaction_async = function(path, rawTxHex) {
	var splitPath = utils.splitPath(path);
...
BexLedgerWallet.prototype.getAppConfiguration_async = function() {
...
BexLedgerWallet.prototype.signPersonalMessage_async = function(path, messageHex) {
	var splitPath = utils.splitPath(path);
	var offset = 0;
...
module.exports = BexLedgerWallet;
